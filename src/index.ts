...
export const superPal = (hexColorIn:string, colorSpace:string=DEFAULT_COLOR_SPACE, maxHueShiftAmount:number=DEFAULT_MAX_HUE_SHIFT_AMOUNT):ColorPalette => {
  ...
  rawHSLspaceHues.forEach((rawHSLspaceHue) => {
    ...
    const hexColor = HSLtoHex([curHueAngleInCorrectColorSpace, correctColorSpaceHSLColor[1], correctColorSpaceHSLColor[2]], colorSpace);
